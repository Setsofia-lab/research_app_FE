  ...
  return (
    <MainLayout>
      <Container size="xl">
        <Flex mb={30}>
          <Box>
            <Text className={classes.generate__header}>
              Thesis Generator - Discussion/Observation
            </Text>
          </Box>
        </Flex>
        <Grid>
          <Grid.Col span={{ lg: 4 }}>
            <SideBar header="Discussions Generator" />
          </Grid.Col>
          <Grid.Col span={{ lg: 8 }}>
            <Flex direction="column" p={20} className={classes.generated__flex}>
              ...
              <ButtonGenerate
                regenerate={{ title: 'Regenerate', link: '/generate/discussion/regenerate' }}
                next={{ title: 'Next', link: '/generate/conclusion' }}
                edit={{ title: 'Edit', link: '/generate/discussion/edit' }}
              />
            </Flex>
          </Grid.Col>
        </Grid>
