  ...
  return (
    <MainLayout>
      <Container size="xl">
        <Flex mb={30}>
          <Box>
            <Text className={classes.generate__header}>Thesis Generator - Introduction</Text>
          </Box>
        </Flex>
        <Grid>
          <Grid.Col span={{ lg: 4 }}>
            <SideBar header="Introduction Generator" />
          </Grid.Col>
          <Grid.Col span={{ lg: 8 }}>
            <Flex direction="column" p={20} className={classes.generated__flex}>
              ...
              <ButtonGenerate
                regenerate={{ title: 'Regenerate', link: '/generate/introduction/regenerate' }}
                next={{ title: 'Next', link: '/generate/literaturereview' }}
                edit={{ title: 'Edit', link: '/generate/introduction/edit' }}
              />
            </Flex>
          </Grid.Col>
        </Grid>
